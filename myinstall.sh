...
sudo mkfs.ext4 -b 4096 $HARDDRIVE$PARTNO
...
# Base Packages
echo -ne '\n' | pacman -S --noconfirm git base-devel elinks efibootmgr bluez wpa_supplicant openvpn connman dialog grub efibootmgr e2fsprogs
